            ...
            <div className="flex flex-row gap-4 items-center" onClick={handleClick}>
              ...
              >
                ...
                >
                  ...
                  <motion.rect animate={{ fill: nextColor1 }} x="588.7" y="109.3" className="st0" width="17.6" height="72.7" />
                  <motion.polygon animate={{ fill: nextColor1 }} className="st0" points="524.8,139.7 524.2,139.7 508.8,109.3 489.2,109.3 515.8,157.7 515.8,182 533.2,182 533.2,157.7 
                  559.8,109.3 540.2,109.3 	"/>
                  <motion.path animate={{ fill: nextColor1 }} className="st0" d="M724.4,129.3c-2.8-1.7-6.1-2.6-10-2.6c-4,0-7.5,1-10.4,2.9c-2.9,1.9-5,4.5-6.2,7.8h-0.6v-10h-16.5V182H698
                  ...
                  <motion.path animate={{ fill: nextColor1 }} className="st0" d="M661,129.3c-2.8-1.7-6.1-2.6-10-2.6c-4,0-7.5,1-10.4,2.9c-2.9,1.9-5,4.5-6.2,7.8h-0.6v-10h-16.5V182h17.4
                  v-31.1c0-2.1,0.4-3.9,1.1-5.3c0.8-1.5,1.8-2.6,3.2-3.4c1.4-0.8,3-1.2,4.8-1.2c2.7,0,4.9,0.9,6.4,2.6c1.6,1.7,2.3,4.1,2.3,7.1V182
                  h17.4v-34.8c0-4.1-0.8-7.7-2.3-10.7C666,133.4,663.8,131,661,129.3z"/>
                  <motion.path animate={{ fill: nextColor1 }} className="st0" d="M1116.8,165.5c-0.8,1.3-1.8,2.3-3.1,3c-1.2,0.7-2.7,1-4.3,1c-2,0-3.8-0.6-5.3-1.7c-1.5-1.1-2.7-2.8-3.5-5
                  ...
                  <motion.rect animate={{ fill: nextColor1 }} x="1055.4" y="127.5" className="st0" width="17.4" height="54.5" />
                  <motion.polygon animate={{ fill: nextColor1 }} className="st0" points="441.6,154.3 440.7,154.3 422.3,109.3 400.5,109.3 400.5,182 417.6,182 417.6,137.1 418.2,137.1 
                  435.7,181.5 446.6,181.5 464.1,137.3 464.7,137.3 464.7,182 481.8,182 481.8,109.3 460.1,109.3 	"/>
                  <motion.rect animate={{ fill: nextColor1 }} x="906.1" y="127.5" className="st0" width="17.4" height="54.5" />
                  <motion.path animate={{ fill: nextColor1 }} className="st0" d="M914.8,104.5c-2.4,0-4.5,0.8-6.3,2.5c-1.8,1.6-2.6,3.6-2.6,5.8c0,2.3,0.9,4.3,2.6,5.9c1.8,1.6,3.8,2.4,6.3,2.4
                  c2.5,0,4.6-0.8,6.3-2.4c1.8-1.6,2.6-3.6,2.6-5.9c0-2.3-0.9-4.2-2.6-5.8C919.3,105.3,917.2,104.5,914.8,104.5z"/>
                  <motion.path animate={{ fill: nextColor1 }} className="st0" d="M978.2,129.3c-2.8-1.7-6.1-2.6-10-2.6c-4,0-7.5,1-10.4,2.9c-2.9,1.9-5,4.5-6.2,7.8H951v-10h-16.5V182h17.4
                  v-31.1c0-2.1,0.4-3.9,1.1-5.3c0.8-1.5,1.8-2.6,3.2-3.4c1.4-0.8,3-1.2,4.8-1.2c2.7,0,4.9,0.9,6.4,2.6c1.6,1.7,2.3,4.1,2.3,7.1V182
                  h17.4v-34.8c0-4.1-0.8-7.7-2.3-10.7C983.2,133.4,981,131,978.2,129.3z"/>
                  <motion.path animate={{ fill: nextColor1 }} className="st0" d="M1030.6,149.8l-10.5-2c-2.3-0.5-3.9-1.1-4.8-1.9c-0.9-0.8-1.3-1.7-1.3-2.8c0-1.4,0.7-2.5,2.1-3.3
                  ...
                  <motion.path animate={{ fill: nextColor1 }} className="st0" d="M784.3,130.3c-4.1-2.4-9-3.6-14.7-3.6c-5.7,0-10.7,1.2-14.8,3.6c-4.1,2.3-7.3,5.6-9.5,9.9
                  ...
                  <motion.path animate={{ fill: nextColor1 }} className="st0" d="M894.1,126.7c-3,0-5.6,0.9-7.8,2.7c-2.2,1.8-3.9,4.4-4.9,8h-0.6v-9.9H864V182h17.4v-29.6
                  ...
                  <motion.path animate={{ fill: nextColor1 }} className="st0" d="M1064.1,104.5c-2.4,0-4.5,0.8-6.3,2.5c-1.8,1.6-2.6,3.6-2.6,5.8c0,2.3,0.9,4.3,2.6,5.9
                  ...
                  <motion.polygon animate={{ fill: nextColor1 }} className="st0" points="799.6,123.5 821.7,123.5 821.7,182 839,182 839,123.5 861.1,123.5 861.1,109.3 799.6,109.3 	" />
                </g>
              </svg>
