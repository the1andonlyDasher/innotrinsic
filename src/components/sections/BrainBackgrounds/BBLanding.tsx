...
const BBLanding: FunctionComponent<BBLandingProps> = () => {
    ...
    return (
        <Sec single left sectionName="business" id="first">
            <motion.div
            ...
            >
                ...
                <motion.div className="left__wrapper">
                    <motion.header variants={variants} className="landing__header business">
                        Erfahre mehr über deinen besten Freund:<br />
                        <strong className="business">Dein Gehirn.</strong>
                    </motion.header>
                    <motion.p variants={variants} className="landing__text business">
