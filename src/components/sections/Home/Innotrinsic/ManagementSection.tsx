...
interface InnotrinsicManagementSectionProps {

}

const InnotrinsicManagementSection: FC<InnotrinsicManagementSectionProps> = () => {
    return <Sec single left sectionName="mountain" addClass="full-width bg-[#f1eacd]">
        <><motion.div className="content-grid management__wrapper">
...
export default InnotrinsicManagementSection;