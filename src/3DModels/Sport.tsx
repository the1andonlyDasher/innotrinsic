...
Command: npx gltfjsx@6.2.16 public/Sport.glb --types --output src/Sport.tsx 
*/
...
export function Sport(props: JSX.IntrinsicElements['group']) {
  const group: any = useRef<Group>()
  const { nodes, materials, animations } = useGLTF('/Sport.glb') as GLTFResult
